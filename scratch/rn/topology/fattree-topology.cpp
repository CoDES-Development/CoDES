                                 ...
                                 bool only_reconfiguration)
{
    ...
    number_of_pod = k;
    number_of_aggre_switches_per_pod = k / 2;
    number_of_edge_switches_per_pod = k / 2;
    number_of_servers_per_edge_switch = (k / 2);
    number_of_servers_per_pod = number_of_servers_per_edge_switch * number_of_edge_switches_per_pod;
    number_of_core_switches = (k / 2) * (k / 2);
    number_of_aggre_switches = number_of_aggre_switches_per_pod * number_of_pod;
    number_of_edge_switches = number_of_edge_switches_per_pod * number_of_pod;
    number_of_servers = number_of_servers_per_pod * number_of_pod;
