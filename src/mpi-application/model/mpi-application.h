...
namespace ns3 {
    ...
    private:
        ...
        static MPIOperation<std::unordered_map<MPIRankIDType, std::shared_ptr<MPISocket>>> connect(size_t cache_limit, MPIRankIDType rankID, NS3Node node, const std::map<MPIRankIDType, Address> &addresses, const std::map<Address, MPIRankIDType> &ranks);
    ...
    public:
        ...
        MPIOperation<void> Initialize(size_t mtu_size = 1492);
