...
ns3::MPICommunicator::MPICommunicator(ns3::MPIRankIDType rankID, const std::shared_ptr<std::mt19937> &randomEngine, std::unordered_map<MPIRankIDType, std::shared_ptr<MPISocket>> &&sockets) noexcept:
        rankID(rankID),
